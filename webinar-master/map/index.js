...
angular.module('farmbuild.webmapping.examples', ['farmbuild.webmapping'])
	...
	.controller('MapCtrl',
	function ($http, $scope, $log, $location, $rootScope, $filter, webmapping, soilTypeExtension) {
		//colourExtension
		//soilTypeExtension
		var
		...
		$scope.getSoilTypeInformation = function () {
			alert("calling soil service");
			var token='eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6InpmUDJxREpRSEdyZXU1RVRMeE4zUVpQd0xuUSIsImtpZCI6InpmUDJxREpRSEdyZXU1RVRMeE4zUVpQd0xuUSJ9..p2_eGGNoaq80vLK5wkL4ggzfxlJllqIMwqyhxkclRkZu92QA--Ak-zRbK6nKVLOf6mJTf4JRcyI4pQhL4DpTSmkO4CIBIHdQFJf4SGZu4M24KgJzZa3nPK1zbzX1vC4XzwzfGn-tcAUD0fx0zdRwoMFVzEEwJkyQ11ILcmutYdD2iK_V_LXwV1GcO-2opC4Sbeay72jANtbj6usWulD1F15-9I5PN0kzjbjzOzh7qbYWhIRAiAPEpKgPtUUna3AK7xZUR_fjo50GDsLzl0w9tDHOr4ETDMe-JWmdT4bOOsjFCjxjS-rYaaCOaVTaIJ6QC9jdARd3bWgY71-ocSmRnQ';
			var wfsUrl = 'https://farmbuild-soil.agriculture.vic.gov.au/areas';
			$scope.error = false;
            $scope.errorMessages = [];
            $scope.messages = [];
	            /**
		...
		function execute(reqConfig) {
            ...
            res.success(function (data, status, headers, config) {
                 ...
                 */
                //var farmSoilInfo = farmSoilArea(data);
                ...
                alert("success");
                alert($scope.rawMsg);
                $scope.farmData = webmapping.load(angular.fromJson($scope.rawMsg));
		...
		*/
		...
		$scope.loadFarmData = function () {
			...
			if(typeof soilTypeExtension != 'undefined') {
				soilTypeExtension.colourPaddocks(olMap);
			}
		};
